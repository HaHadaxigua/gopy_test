# python build stubs for package factory
...
mod.add_function('Slice_factory_XInterface_CTor', retval('int64_t'), [])
mod.add_function('Slice_factory_XInterface_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_factory_XInterface_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
...
mod.add_function('factory_A_NameA_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('factory_A_NameA_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
add_checked_function(mod, 'factory_A_DoA', None, [param('int64_t', '_handle'), param('bool', 'goRun')])
add_checked_function(mod, 'factory_A_DoB', retval('char*'), [param('int64_t', '_handle')])
mod.add_function('factory_B_CTor', retval('int64_t'), [])
mod.add_function('factory_B_NameB_Get', retval('char*'), [param('int64_t', 'handle')])
