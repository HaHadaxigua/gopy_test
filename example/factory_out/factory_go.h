...
/* package gopy_test/example/factory_out */
...
extern long long int Slice_factory_XInterface_CTor();
extern GoInt Slice_factory_XInterface_len(long long int handle);
extern long long int Slice_factory_XInterface_elem(long long int handle, GoInt _idx);
...
extern long long int factory_A_CTor();
extern char* factory_A_NameA_Get(long long int handle);
extern void factory_A_NameA_Set(long long int handle, char* val);
extern void factory_A_DoA(long long int _handle, char goRun);
extern char* factory_A_DoB(long long int _handle);

// --- wrapping struct: factory.B ---
extern long long int factory_B_CTor();
extern char* factory_B_NameB_Get(long long int handle);
